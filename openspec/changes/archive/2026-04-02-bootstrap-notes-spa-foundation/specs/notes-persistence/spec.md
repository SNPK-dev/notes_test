...
Система SHALL восстанавливать ранее сохранённые заметки после перезагрузки приложения. Persisted state MUST быть отделён от transient editor state, чтобы reload восстанавливал только сохранённые данные.
