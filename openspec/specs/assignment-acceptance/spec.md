...
Зафиксировать полную requirement-by-requirement acceptance traceability для test assignment и инженерных ожиданий, чтобы финальная сдача опиралась на явные доказательства: код, unit tests, Playwright, delivery checks и один короткий manual acceptance pass.
